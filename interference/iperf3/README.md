...
# modify iperf_client1.yaml file that make sure the ip address should be the `kubectl get svc -n robot-shop | grep iperf`
kubectl apply -f iperf_client1.yaml -n robot-shop
kubectl logs iperf3_client_xxxxxx -n robot-shop
```
