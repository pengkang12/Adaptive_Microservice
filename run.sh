...
#python3.6 locust_new.py -f input_data/inputTest.txt -pName prometheus-operator-685cb6b46b-l6hrd -k8url $web_url:$web_port -locustF robot-shop.py >> /tmp/locust.log &
